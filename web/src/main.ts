...
function shellView() {
  const accounts = `<div class="account-results" id="account-results" role="status" aria-live="polite" aria-atomic="true">${state.accountResults.map(accountResultView).join('')}</div>`
